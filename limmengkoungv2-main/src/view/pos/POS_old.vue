          ...
          <template #content>
            <div class="flex flex-wrap flex-row mt-5">
              <div class="search flex grow">
                <div>
                  <Button label="Show Categories" @click="visible = true" class="me-2 w-ful" />
              ...
              <div class="filters grid md:grid-cols-1 gap-2 mt-5 2xl:mt-0 w-full 2xl:w-fit">
                <Select v-model="filter_customer" :options="customer" showClear optionLabel="name" placeholder="Customer" />
